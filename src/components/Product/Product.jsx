...
export function Product({onProductLike, pictures, likes = [], reviews, tags, name, price, discount, description, wight, _id, currentUser}) {
         ...
         {discount && <span className={cn(s.price, 'card__price_type_discount')}>{discount_price}&nbsp;₽</span>}
          ...
          <div className={s.delivery}>
            ...
            <div className={s.right}>
              ...
              <p className={s.text}>Если вам не понравилось качество нашей продукции, мы вернем деньги, либо сделем все возможное, чтобы удовлетворить ваши нужды</p>
            </div>
          </div>
